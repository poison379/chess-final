export const ChessPieces = {
  ...
  K: (
    <svg viewBox="0 0 45 45" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
      <g fill="#fff" stroke="#000" strokeWidth="1.5">
        <path d="M 22.5,11.63 V 6 M 20,8 h 5" strokeLinejoin="miter" />
        <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 25.5,14.5 24.5,12 22.5,12 20.5,12 19.5,14.5 19.5,14.5 18,17.5 22.5,25 22.5,25" />
        <path d="M 12.5,37 C 18,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 3.5,25.5 12.5,30 12.5,30 L 12.5,37" />
